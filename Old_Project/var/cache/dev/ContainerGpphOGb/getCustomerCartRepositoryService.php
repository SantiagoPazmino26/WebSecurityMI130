...
// Returns the private 'App\Repository\CustomerCartRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CustomerCartRepository.php';

return $this->privates['App\Repository\CustomerCartRepository'] = new \App\Repository\CustomerCartRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
